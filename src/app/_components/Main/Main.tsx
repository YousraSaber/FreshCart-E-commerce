          ...
          <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
            <motion.div whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className="px-6 py-3 text-base font-semibold text-white rounded-lg bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-green-300"
              >
                Start Shopping
              </Link>
            </motion.div>
            ...
            <motion.div whileTap={{ scale: 0.95 }}>
              <Link
                href="/categories"
                className="px-6 py-3 text-base font-medium text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700"
              >
                Browse Categories
              </Link>
            </motion.div>
